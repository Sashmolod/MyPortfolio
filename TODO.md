...
- [x] Добавить middleware сжатия
- [x] Добавить CORS конфигурацию для production


### Безопасность
- [x] Реализовать CSRF-защиту
- [x] Добавить ограничения на размер тела запроса
- [x] Добавить заголовки helmet.js (через пакет `helmet`)
- [x] Добавить требования к сложности пароля
- [x] Добавить блокировку аккаунта после неудачных попыток
...
- [x] Добавить заголовки Content-Security-Policy
...
- [x] Добавить диаграмму схемы базы данных (создан DB_SCHEMA.md)
- [x] Добавить руководство по развёртыванию (создан DEPLOYMENT_GUIDE.md)
- [x] Добавить правила внесения вкладов (создан CONTRIBUTING.md)
