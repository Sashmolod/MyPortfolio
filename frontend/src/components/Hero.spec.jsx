...
vi.mock('framer-motion', () => {
  ...
  const DummyDiv = React.forwardRef(({ children, animate, initial, exit, transition, ...props }, ref) => {
...
describe('Hero Component', () => {
  ...
  it('renders default info when no data is provided', () => {
    ...
    expect(screen.getByText('Passionate developer creating amazing web experiences.')).toBeInTheDocument();
  });
