...
vi.mock('framer-motion', () => {
  ...
  const DummyDiv = React.forwardRef(({ children, whileInView, viewport, initial, transition, ...props }, ref) => {
...
describe('Skills Component', () => {
  ...
  it('renders custom skills with correct level styling', () => {
    const customSkills = [
      { id: 1, name: 'WebAssembly', icon: 'wasm', level: 95, description: 'Super fast execution' },
      { id: 2, name: 'GraphQL', icon: 'graphql', level: 75, description: 'Query api' },
    ];
