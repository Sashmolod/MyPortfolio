...
export function DeveloperIllustration({ className = "" }) {
  return (
    ...
    >
      ...
      >{`{`}</text>
      <text x="135" y="150" fill="#f59e0b" fontSize="9" fontFamily="monospace">
        name
      </text>
      <text x="170" y="150" fill="#6ee7b7" fontSize="9" fontFamily="monospace">
        = "Dev"
      </text>
      <text x="125" y="168" fill="#6ee7b7" fontSize="9" fontFamily="monospace">
        skills
      </text>
      <text x="170" y="168" fill="#a78bfa" fontSize="9" fontFamily="monospace">
        = [⚡, 🚀]
      </text>
      <text
        x="125"
      ...
      >
        <animate
          attributeName="d"
          values="M315 215 Q317 208 315 200;M315 215 Q313 208 315 200;M315 215 Q317 208 315 200"
          dur="2s"
          repeatCount="indefinite"
        />
      </path>
      <path
        d="M325 213 Q327 206 325 198"
        stroke="#cbd5e1"
        strokeWidth="1.5"
        fill="none"
        opacity="0.4"
      >
        <animate
          attributeName="d"
          values="M325 213 Q327 206 325 198;M325 213 Q323 206 325 198;M325 213 Q327 206 325 198"
          dur="2.5s"
          repeatCount="indefinite"
        />
      </path>
      ...
      {/* Блик */}
      <path
        d="M110 90 Q200 85 290 90 L290 100 Q200 95 110 100 Z"
        fill="white"
        opacity="0.1"
      />
...
export function NodeIcon({ size = 24 }) {
  return (
    ...
    >
      <path
        d="M12 2L4.5 6.5V17.5L12 22L19.5 17.5V6.5L12 2Z"
        stroke="#68A063"
        strokeWidth="1.5"
        fill="none"
      />
...
export function PythonIcon({ size = 24 }) {
  return (
    ...
    >
      <path
        d="M12 2C8 2 8.5 5 8.5 5V7H12V9H6S2.5 9.5 2.5 14.5S5 22 9 22H10V20H9C7 20 7 17 7 17V12H11L12 11H16V9H8"
        fill="#3776AB"
      />
      <path
        d="M12 22C16 22 15.5 19 15.5 19V17H12V15H18S21.5 13.5 21.5 8.5 19 2 15 2H14V4H15C17 4 17 7 17 7V12H13L12 13H8V15H16"
        fill="#FFD435"
      />
    </svg>
  );
...
export function DatabaseIcon({ size = 24 }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M4 5V19C4 20.66 7.58 22 12 22C16.42 22 20 20.66 20 19V5"
        stroke="#336791"
        strokeWidth="1.5"
      />
      <path
...
export function DockerIcon({ size = 24 }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M3 14C3 12.9 5 12 7 12C9 12 10 14 12 14C14 14 16 12 18 12C20 12 21 12.9 21 14V17C21 18.1 19 19 17 19H7C5 19 3 18.1 3 17V14Z"
        fill="#0DB7ED"
        opacity="0.5"
      />
    </svg>
...
export function RocketIcon({ size = 48, className = "" }) {
  return (
    ...
    >
      {/* Корпус ракеты */}
      <path
        d="M32 4C32 4 20 18 20 36L16 44H48L44 36C44 18 32 4 32 4Z"
        fill="url(#rocketGrad)"
        stroke="#e2e8f0"
        strokeWidth="1"
      />
      {/* Нос */}
      <path
        d="M32 4C32 4 26 12 26 20L32 24L38 20C38 12 32 4 32 4Z"
        fill="#667eea"
        opacity="0.5"
      />
      {/* Окно */}
      ...
      {/* Крылья */}
      <path
        d="M20 36L12 48H22L24 44"
        fill="#e53e3e"
        stroke="#c53030"
        strokeWidth="0.5"
      />
      <path
        d="M44 36L52 48H42L40 44"
        fill="#e53e3e"
        stroke="#c53030"
        strokeWidth="0.5"
      />
      {/* Пламя */}
      <path
        d="M24 44C24 44 26 52 32 56C38 52 40 44 40 44"
        fill="url(#flameGrad)"
        opacity="0.9"
      >
        <animate
          attributeName="d"
          values="M24 44C24 44 26 52 32 56C38 52 40 44 40 44;M24 44C24 44 27 54 32 58C37 54 40 44 40 44;M24 44C24 44 26 52 32 56C38 52 40 44 40 44"
          dur="0.3s"
          repeatCount="indefinite"
        />
      </path>
...
export function MailIcon({ size = 48, className = "" }) {
  return (
    ...
    >
      ...
      {/* Блик */}
      <path
        d="M8 20L32 38L56 20V50C56 52.2 54.2 54 52 54H12C9.8 54 8 52.2 8 50V20Z"
        fill="white"
        opacity="0.05"
      />
      {/* Анимация - волна */}
      <path
        d="M30 24L32 26L34 24"
        stroke="#667eea"
        strokeWidth="1.5"
        strokeLinecap="round"
        opacity="0.5"
...
export function ProjectIcon({ size = 48, className = "" }) {
  return (
    ...
    >
      {/* Папка */}
      <path
        d="M8 16C8 14.9 8.9 14 10 14H26L32 22H54C55.1 22 56 22.9 56 24V50C56 51.1 55.1 52 54 52H10C8.9 52 8 51.1 8 50V16Z"
        fill="url(#folderGrad)"
        stroke="#e2e8f0"
        strokeWidth="1"
      />
