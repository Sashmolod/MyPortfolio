...
// Mock Subcomponents
vi.mock('../components/ConfirmDialog', () => ({ default: () => <div data-testid="mock-confirm" /> }));
vi.mock('../components/MediaTab', () => ({ default: () => <div data-testid="mock-media" /> }));
vi.mock('../components/TrashView', () => ({ default: () => <div data-testid="mock-trash" /> }));
vi.mock('../components/SkillForm', () => ({ default: () => <div data-testid="mock-skill-form" /> }));
vi.mock('../components/ProjectForm', () => ({ default: () => <div data-testid="mock-project-form" /> }));
vi.mock('../components/HeroForm', () => ({ default: () => <div data-testid="mock-hero-form" /> }));
vi.mock('../components/SocialLinkForm', () => ({ default: () => <div data-testid="mock-social-link" /> }));
vi.mock('../components/StatsView', () => ({ default: () => <div data-testid="mock-stats" /> }));
...
describe('AdminDashboard Page', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(api.get).mockImplementation((url) => {
      ...
      if (url === '/admin/projects') {
        return Promise.resolve({
          data: [
            { id: 1, title: 'Storefront', description: 'Store' },
          ],
        });
      }
  ...
  it('toggles settings via PUT request', async () => {
    ...
    await waitFor(() => {
      expect(mockUpdateSettingsLocally).toHaveBeenCalledWith({ enableBug: true });
      expect(api.put).toHaveBeenCalledWith('/admin/settings', { enableBug: true });
      expect(window.toast).toHaveBeenCalledWith('Настройки обновлены / Settings updated', 'success');
    });
  });
