  ...
  const handleMakeSketch = async () => {
    ...
    try {
      ...
      await new Promise((resolve, reject) => {
        img.onload = resolve;
        img.onerror = () => reject(new Error('Failed to load avatar image for sketching'));
      });
            ...
            {form.avatar && (
              <div style={{ marginTop: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <button 
                  ...
                  style={{ padding: '4px 8px', fontSize: '12px', margin: 0, backgroundColor: 'var(--accent)', color: 'var(--text)' }} 
